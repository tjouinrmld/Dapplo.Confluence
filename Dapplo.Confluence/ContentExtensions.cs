...
namespace Dapplo.Confluence
{
	...
	public static class ContentExtensions
	{
		...
		public static async Task<Content> CreateAsync(this IContentDomain confluenceClient, string type, string title, string spaceKey, string body, CancellationToken cancellationToken = default(CancellationToken))
		{
